...
def dct1_4d(x, norm=None):
    ...
    X1 = dct1(x)
    X2 = dct1(X1.transpose(-1, -2))
    X3 = dct1(X2.transpose(-1, -3))
    X4 = dct1(X3.transpose(-1, -4))
...
def dct_4d(x, norm=None):
    ...
    X2 = dct(X1.transpose(-1, -2), norm=norm)
    X3 = dct(X2.transpose(-1, -3), norm=norm)
    X4 = dct(X3.transpose(-1, -4), norm=norm)
    return X4.transpose(-1, -4).transpose(-1, -3).transpose(-1, -2)


# def idct_4d(X, norm=None):
def idct_4d(X, norm=None):
    """
    The inverse to 3D DCT-II, which is a scaled Discrete Cosine Transform, Type III
    Our definition of idct is that idct_3d(dct_3d(x)) == x
...
def dct_5d(x, norm=None):
    ...
    X3 = dct(X2.transpose(-1, -3), norm=norm)
    X4 = dct(X3.transpose(-1, -4), norm=norm)
    X5 = dct(X4.transpose(-1, -5), norm=norm)
    return X5.transpose(-1, -5).transpose(-1, -4).transpose(-1, -3).transpose(-1, -2)


def idct_5d(X, norm=None):
    """
    The inverse to 3D DCT-II, which is a scaled Discrete Cosine Transform, Type III
    Our definition of idct is that idct_3d(dct_3d(x)) == x
    For the meaning of the parameter `norm`, see:
    ...
    x3 = idct(x2.transpose(-1, -3), norm=norm)
    x4 = idct(x3.transpose(-1, -4), norm=norm)
    x5 = idct(x4.transpose(-1, -5), norm=norm)
    return x5.transpose(-1, -5).transpose(-1, -4).transpose(-1, -3).transpose(-1, -2)
